...
const Footer = () => {
  return (
    <>
      <footer className="relative mt-auto z-10 pb-10 pt-20 lg:pb-20 lg:pt-[120px]">
        <div className="max-width-wrapper">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <Link to={'/'} className="mb-6 inline-block max-w-[160px]">
                  <img src={mentoraLogo} alt="logo" className="max-w-full" />
                </Link>
                <p className="mb-7 text-base text-body-color">
                  Our mission is to empower individuals to achieve their
                  personal and professional goals through accessible and
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <ul className="mb-6 flex items-center">
                  <li className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-solid hover:bg-eminence-500 hover:text-white  sm:mr-4 lg:mr-3 xl:mr-4">
                    <svg
                      width="8"
                      height="16"
                      viewBox="0 0 8 16"
                  ...
                  <li className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-solid hover:bg-eminence-500 hover:text-white y sm:mr-4 lg:mr-3 xl:mr-4">
                    <svg
                      width="16"
                      height="12"
                      viewBox="0 0 16 12"
                  ...
                  <li
                    ...
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-solid hover:bg-eminence-500 hover:text-white y sm:mr-4 lg:mr-3 xl:mr-4">
                    <svg
                      width="14"
                      height="14"
                      viewBox="0 0 14 14"
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  &copy; {new Date().getFullYear()} Mentora
                </p>
              </div>
            </div>
          </div>
        </div>
        <div className="text-center text-clr-shark/70 pt-4 border-t">
          Designed and developed by{' '}
          <Link
            to="https://github.com/amirulkanak"
            className="italic underline text-minsk-400">
            Amirul Kanak
          </Link>
        </div>
      </footer>
